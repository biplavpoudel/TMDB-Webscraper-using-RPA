...
movie_card_path = '//*[@id="main"]/section/div/div/div[2]/section/div[@class="search_results movie "]/div/'
second_part_path = 'div/div[2]/div[1]/div/div/a/'

single_movie_link = movie_card_path + 'div[1]/div/div[2]/div[1]/div/div/a[@data-media-type="movie"]'
